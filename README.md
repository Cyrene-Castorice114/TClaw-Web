...
**中文：**基于原生 HTML / CSS / JavaScript 的个人主页，左右分栏布局。集成动态背景图、链接卡片、开源项目展示、友情链接、README 阅读器、深色/浅色主题、多种点击特效、缓存优化等功能。

**English：** A personal homepage built with vanilla HTML / CSS / JavaScript, Split-pane layout on desktop with dynamic backgrounds, link cards, open-source projects, friend links, README viewer, dark/light theme, click effects, and cache optimization.
